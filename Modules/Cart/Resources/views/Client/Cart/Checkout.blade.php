                        ...
                        <div class="right-side-summery-box">
                            <div class="summery-box-2">
                                ...
                                <ul class="summery-total">
                                    ...
                                    <li>
                                        @if(\Modules\Cart\Helpers\Cart\Cart::sumDiscount() > 0)
                                            <h4>تخفیف</h4>
                            ...
                            <div class="mt-5">
                                <label for="policyChecked">تایید <a href="#">شرایط و قوانین</a></label>
                                <input class="" type="checkbox" name="policyChecked" id="policyChecked">
                            </div>
                            <button id="submitOrder" disabled class="btn theme-bg-color text-white btn-md w-100 mt-4 fw-bold">ثبت سفارش</button>
                            <span class="text-danger text-center w-100">لطفا تمامی مقادیر را ثبت کنید</span>
                        </div>
                    </div>
