                    ...
                    <div class="navbar-top">
                        ...
                        <div class="rightside-box">
                            ...
                            <ul class="right-side-menu">
                                ...
                                <li class="right-side">
                                    <a href="{{route('profile.wishlist.index')}}" class="btn p-0 position-relative header-wishlist">
                                            ...
                                            <ul class="cart-list" id="cartBox">
                                                ...
                                                @foreach(\Modules\Cart\Helpers\Cart\Cart::all() as $cart)
                                                    @if(isset($cart['product']))
                                                        ...
                                                        @endphp
                                                        <li class="product-box-contain" id="cart{{$cart['id']}}" data-productId="{{$product->id}}">
                                                            <div class="drop-cart">
