            ...
            <div id="step1" class="tab-content__pane active px-5 sm:px-20 mt-10 pt-10 border-t border-gray-200" >
                ...
                <div class="grid grid-cols-12 gap-4 row-gap-5 mt-5 rtl">
                    <div class="intro-y col-span-12 sm:col-span-6">
                        ...
                        <input type="text" name="email" class="input w-full border flex-1" placeholder="example@gmail.com">
                    </div>
                    <div class="intro-y col-span-12 sm:col-span-6">
                        <div class="mb-2">شماره مبایل</div>
                        <input type="text" name="phone" class="input w-full border flex-1" placeholder="09124805562">
                    </div>
                    <div class="intro-y col-span-12 sm:col-span-6">
                        <div class="mb-2">نام کاربری</div>
                        <input type="text" name="username" class="input w-full border flex-1" placeholder="userName">
                    </div>
                    <div class="intro-y col-span-12 sm:col-span-3">
                        <div class="mb-2">رمز عبور</div>
                        <input type="password" name="password" id="password"  class="input w-full border flex-1" placeholder="*******">
                    </div>
                    <div class="intro-y col-span-12 sm:col-span-3">
