    ...
    <div class="pos intro-y grid grid-cols-12 gap-5 mt-5">
        ...
        <div class="intro-y col-span-12 lg:col-span-8">
            <div class="flex">
                ...
                <input type="text" name="nickName" id="nickName" class="intro-y col-span-6 input input--lg w-1/2 box pr-10 placeholder-theme-13 " value="{{old('nickName')}}" style="text-align:left;direction: ltr !important;" placeholder="English Name ">
                ...
                <div class="post__content tab-content ">
                    <div class="tab-content__pane p-5 active" id="content">
                        <div class="border border-gray-200 rounded-md p-5">
                            ...
                            <div class="mt-5">
                                <textarea data-feature="all" class="summernote" data-height="250" name="description" id="description" value="{{old('description')}}"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="tab-content__pane p-5 " id="abstract">
                        <div class="border border-gray-200 rounded-md p-5">
                            ...
                            <div class="mt-5">
                                <textarea data-feature="all" class="summernote" data-height="250" name="abstract" id="abstract" value="{{old('abstract')}}"></textarea>
                            </div>
                        </div>
                    </div>
