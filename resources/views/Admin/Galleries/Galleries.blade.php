        ...
        <div class="col-span-12 lg:col-span-9 xxl:col-span-10">
            ...
            <div class="intro-y flex-justify-profile flex-col-reverse sm:flex-row items-center">
                <div class="w-full sm:w-auto flex">
                    <a data-toggle="modal" data-target="#CreateNewFile" href="javascript:;" class="button text-white bg-theme-1 shadow-md mr-2"  >بارگزاری فایل جدید</a>
                ...
                @foreach($galleries as $gallery)
                    ...
                    <div class="intro-y col-span-6 sm:col-span-4 md:col-span-3 xxl:col-span-2">
                        <div class="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in">
                            ...
                            <a class=" w-5 h-5 block tooltip "@if($gallery->created_at) title="{{$gallery->created_at}} آپلود شده در" @endif data-theme="dark" href="javascript:;"> <i data-feather="activity" class="w-5 h-5 text-gray-500"></i> </a>
                                <div class="absolute top-0 right-0 mr-2 mt-2 dropdown ml-auto">
                                    ...
                                    <div class="dropdown-box mt-5 absolute w-40 top-0 right-0 z-10">
                                        <div class="dropdown-box__content box p-2">
                                            ...
                                            <a href="javascript:;" data-toggle="modal" id="submit" data-target="#galleryEdit{{$gallery->id}}" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="trash" class="w-4 h-4 mr-2"></i>ویرایش</a>
                                        </div>
                                    </div>
                                </div>
                        </div>
            ...
            <div class="mt-5 flex-justify-profile intro-y col-span-12 sm:flex-row sm:flex-no-wrap items-center ">
                {{--                                {{$gallerys->links()}}--}}
                @include('Pagination.Admin', ['paginator' => $galleries,'route' => 'galleries'])
            </div>            <!-- END: Pagination -->
        </div>
                    ...
                    <div class="modal__content">
                        <form action="{{route('galleries.destroy',$gallery->id)}}" method="post" >
                            ...
                            <div class="p-5 text-center"> <i data-feather="x-circle" class="w-16 h-16 text-theme-6 mx-auto mt-3"></i>
                                <div class="text-3xl mt-5">حذف برند  <span style="color: darkred">{{$gallery->title}}</span></div>
                                {{--                        <div class="mt-3 ">--}}
                            ...
                            <div class="mt-4 " id="">
                                ...
                                <div class="mt-1 ">
                                    <select class="select2 block w-full border  mt-2" name="flag" style="width: 100% !important;">
                                        ...
                                        <option value="Ext" @if($gallery->flag == 'Exa')selected @endif label="اسلایدر ها">Exa</option>
                                    </select>
                                </div>
