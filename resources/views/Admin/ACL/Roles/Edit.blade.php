    ...
    <div class="pos intro-y grid grid-cols-12 gap-6 mt-5">
        <div class="col-span-12 lg:col-span-12">
            <h2 class="intro-y text-lg font-medium mt-10 flex">
                ویرایش مقام جدید            </h2>
            <p class="intro-y text-xs font-medium  flex mb-5 " style="color: #4a5568">برای ویرایش مقام جدید فیلد های مورد نظر را پر کرده و در نهایت اطلاعات را ذخیره کنید</p>
            <hr>
        </div>
        {{--Begin new Category--}}
                                ...
                                <div class="p-5 " id="input">
                                    <div class="preview grid-rtl grid-cols-12 ">
                                        <div class="col-span-6 ml-2">
                                            ...
                                            <input name="name" id="name" type="text" class="input w-full border mt-2 align-right" value="{{old('name',$role->name)}}" style="direction: rtl" placeholder="نام">
                                        </div>
                                        <div class=" ml-2 col-span-6">
                                            ...
                                            <input name="label" id="label" type="text" class="input w-full border mt-2 align-right" value="{{old('name',$role->label)}}" style="direction: rtl" placeholder="نام فارسی">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@component('Admin.Layout.Layout1')
    @slot('breadcrump')
        <div class="-intro-x breadcrumb ml-auto hidden sm:flex">
            <a  class="" disabled >ویرایش مقام</a>
