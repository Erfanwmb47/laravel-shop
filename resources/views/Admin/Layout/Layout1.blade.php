...
<div class="flex">
    ...
    <nav class="side-nav">
        ...
        <ul>
            ...
            @if(\Illuminate\Support\Facades\Auth::user()->role->categories > 7 )
            <li>
                ...
                <ul class="">
                    ...
                    @if(\Illuminate\Support\Facades\Auth::user()->role->categories > 11 )
                    <li>
            ...
            @endif
            @if(\Illuminate\Support\Facades\Auth::user()->role->brands > 7 )
            <li>
                <a href="javascript:;" class="side-menu">
                ...
                <ul class="">
                    <li>
                        <a href="{{route('brands.index')}}" class="side-menu">
                            <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                            <div class="side-menu__title"> برندها </div>
                        </a>
                    </li>
                    @if(\Illuminate\Support\Facades\Auth::user()->role->brands > 11 )
                    <li>
            ...
            @endif
            @if(\Illuminate\Support\Facades\Auth::user()->role->users > 7 )
            <li>
                <a href="javascript:;" class="side-menu">
                ...
                <ul class="">
                    ...
                    @if(\Illuminate\Support\Facades\Auth::user()->role->users > 11 )
                    <li>
            ...
            @endif
            @if(\Illuminate\Support\Facades\Auth::user()->role->products > 7 )
            <li>
                <a href="javascript:;" class="side-menu">
                ...
                <ul class="">
                    ...
                    @if(\Illuminate\Support\Facades\Auth::user()->role->products > 11 )
                    <li>
            ...
            @endif
            @if(\Illuminate\Support\Facades\Auth::user()->role->roles > 7 )
            <li>
                <a href="javascript:;" class="side-menu">
                    <div class="side-menu__icon"> <i data-feather="lock"></i> </div>
                    <div class="side-menu__title"> نقش ها  <i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
                </a>
                <ul class="">
                    <li>
                    ...
                    @if(\Illuminate\Support\Facades\Auth::user()->role->roles > 11 )
                    <li>
                        <a href="{{route('roles.create')}}" class="side-menu">
                            <div class="side-menu__icon"> <i data-feather="edit-2"></i> </div>
                            <div class="side-menu__title"> ایجاد نقش </div>
                        </a>
                    </li>
                    @endif
                </ul>
            ...
            <li>
                ...
                <ul class="">
                    ...
                    <li>
                        <a href="{{route('galleries.create')}}" class="side-menu">
                            <div class="side-menu__icon"> <i data-feather="edit-2"></i> </div>
                            <div class="side-menu__title"> ایجاد رسانه </div>
                        </a>
                    </li>
    ...
    <div class="content">
        ...
        <div class="top-bar ">
            ...
            <div class="intro-x dropdown w-8 h-8 relative">
                ...
                <div class="dropdown-box mt-10 absolute w-56 top-0 left-0 z-20">
                    <div class="dropdown-box__content box bg-theme-38 text-white">
                        ...
                        <div class="p-2">
                            <form action="{{route('users.selfEdit')}}" method="get">
                                @csrf
                                <button  class=" w-full flex-justify-profile items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 rounded-md"> <i data-feather="user" class="w-4 h-4 mr-2"></i> پروفایل کاربری </button>
                            </form>
            ...
            <!-- END: Clock -->
            <!-- BEGIN: Breadcrumb -->
            <div class="-intro-x breadcrumb ml-auto hidden sm:flex"> <a href="" class="">گزارش سایت</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">صفحه اصلی</a> </div>
